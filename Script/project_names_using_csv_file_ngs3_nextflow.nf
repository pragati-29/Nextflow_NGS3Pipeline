...
params.project_status = "old"
//params.bs_samp_list = "/home/pragati_4bc/NGS3Pipeline_Nextflow/Dragen_val_sample/bs_project_list.txt" First create project then project list file
...
process extract_and_upload_samples {
    ...
    bs_samp_list = result.stdout.strip()
...
workflow {
    //Renaming() 
    Create_Project(params.sample_file)
