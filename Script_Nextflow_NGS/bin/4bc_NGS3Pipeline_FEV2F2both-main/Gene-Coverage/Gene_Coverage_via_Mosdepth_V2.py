...
print (file1)
list_df = pd.read_csv(file1[0]) #list can be substituted by file generated via sample_ID.py
...
with open("command.sh", "w") as file:
    ...
    for sample in list_df['Sample_ID']:
        ...
        bed_file_path = f"{path_2}/basespace/Projects/{project_name}/AppResults/{sample}*/Files/TarGT_First_v2_CDS_and_FEV2F2_GRCh37_30_Mar_23.bed"
        print (bed_file_path)
        ...
        command = f"/home/ubuntu/Programs/mosdepth --by {bed_file_path} --thresholds 1,10,20,50,100 {sample} {path_2}/basespace/Projects/{project_name}/AppResults/{sample}*/Files/{sample}*.bam"
