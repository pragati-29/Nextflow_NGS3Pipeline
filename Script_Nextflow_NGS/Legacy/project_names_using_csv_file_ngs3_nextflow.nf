...
=======
>>>>>>> 5de608494a0123e284b39c167b2b746b85498c78
process Renaming{
...
process create_project{
    ...
    file = pd.read_csv("${sample_file}")
    #project_names = f"${project_name}_{current_date}"
...
process extract_and_upload_samples {
    ...
    for i, j in zip(var1['Project_name'], var1['Sample_ID']):
        print(j)
        #command = f"{bs_samp_list} | grep -w {i} | awk -F '|' '{print \$3}' | sed 's/ //g'" 
