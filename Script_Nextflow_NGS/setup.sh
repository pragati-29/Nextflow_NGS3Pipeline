...
BIN_DIR="/home/bioinfo/Nilesh/NGS3_test/Nextflow_update_test/combined_down_up/Script_Nextflow_NGS/bin"
...
export cnv_config="$BIN_DIR/cnv_config_somatic.pl"
export chrLenFile="$BIN_DIR/4bc_NGS3Pipeline_FEV2F2both-main/CNV/my_genome.fa.fai"
...
export IGV="/home/bioinfo/miniconda3/envs/nf_ngs3pipeline_env/bin/igv"
